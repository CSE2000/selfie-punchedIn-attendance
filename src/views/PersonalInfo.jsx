...
const PersonalInfoForm = () => {
  ...
  const API_ENDPOINT = "http://192.168.1.26:8000/user/me";
    ...
    const fetchUserData = async () => {
      try {
        ...
        if (panelData) {
          ...
          // console.log("userLeave:", panelData.userLeave);
          // console.log("userAuth:", panelData.userAuth);
          // console.log("userPayment:", panelData.userPayment);
          // console.log("salaryRecord:", panelData.salaryRecord);
          // console.log("officeHoliday:", panelData.officeHoliday);
        }
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Ensure we include the userId/empId in the request
      const dataToSubmit = {
        ...userData,
      ...
      const response = await axios.put(API_ENDPOINT, dataToSubmit, {
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white overflow-y-auto flex flex-col px-4 pt-6 pb-16 sm:rounded-lg sm:mx-auto sm:my-8 sm:max-w-lg shadow-lg">
      {/* Debug part code to get check data is getting properly in the ui */}
...
//     employment: {
//       fields: [
//         { key: "photo", label: "Upload your photo", type: "file" }, // assuming not part of API yet
//       ],
//     },
//   };
...
//   const handleSubmit = () => {
//     console.log("Data for review only:", userData);
//     alert("Review complete. Data was not submitted (GET only).");
//   };
...
//               </select>
//             ) : field.type === "file" ? (
//               <div className="w-full flex justify-center items-center border border-dashed border-gray-400 rounded-md p-6">
//                 <input
//                   type="file"
//                   className="hidden"
//                   id="photo-upload"
