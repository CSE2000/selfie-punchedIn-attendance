  ...
  const handlePunchOut = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://192.168.1.26:8000/data/${punchInId}`,
        { punchOut: punchOutTime },
        {
          headers: {
...
//                 {/* Action Button - Only show when selfie is captured */}
//                 {selfieImage && (
//                   <button
//                     onClick={handlePunchIn}
//                     className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 mt-4 rounded-full"
//                   >
//                     Punched In
//                   </button>
//                 )}
